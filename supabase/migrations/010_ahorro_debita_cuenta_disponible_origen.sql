-- Ahorro: además de sumar la cuenta destino y actualizar `balances`, descontar la cuenta
-- disponible de origen cuando `p_origen` viene como «Banco · Producto» (mismo formato que destino).
-- Así las tarjetas del panel coinciden con los totales globales.
